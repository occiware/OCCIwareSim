 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.clouddesigner.occi.simulation.impl.PoissonImpl#getX <em>X</em>}</li>
 *   <li>{@link org.occiware.clouddesigner.occi.simulation.impl.PoissonImpl#getU <em>U</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PoissonImpl extends MixinBaseImpl implements Poisson {
	/**
	 ...
	 * @ordered
	 */
	protected static final Double U_EDEFAULT = null;
	...
	protected EClass eStaticClass() {
		return SimulationPackage.Literals.POISSON;
	}
	...
	public void setX(Double newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.POISSON__X, oldX, x));
	}
	...
	public void setU(Double newU) {
		...
		u = newU;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulationPackage.POISSON__U, oldU, u));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimulationPackage.POISSON__X:
				return getX();
			case SimulationPackage.POISSON__U:
				return getU();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Probadistrib.class) {
			switch (baseOperationID) {
				case SimulationPackage.PROBADISTRIB___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP: return SimulationPackage.POISSON___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SimulationPackage.POISSON___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
