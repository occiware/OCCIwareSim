...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.simulation.Networksim} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworksimItemProvider extends NetworkItemProvider {
	/**
	 ...
	 * @generated
	 */
	public NetworksimItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Networksim"));
	}
	...
	public String getText(Object object) {
		String label = ((Networksim)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Networksim_type") :
			getString("_UI_Networksim_type") + " " + label;
	}
