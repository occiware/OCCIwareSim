...
public class NewConfigurationWizard extends NewDiagramWizard
{
	...
	{
		super("http://schemas.ogf.org/occi/simulation#", "viewpoint:/org.occiware.clouddesigner.occi.simulation.design/SimulationConfiguration", "simulation", "SimulationConfiguration Diagram");
	}
}
