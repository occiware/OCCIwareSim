...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.simulation.Computesim} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputesimItemProvider extends ComputeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComputesimItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Computesim"));
	}
	...
	public String getText(Object object) {
		String label = ((Computesim)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Computesim_type") :
			getString("_UI_Computesim_type") + " " + label;
	}
